...
@Component({
  selector: 'app-edz-message',
  templateUrl: './edz-message.component.html',
  styleUrls: ['./edz-message.component.scss']
})
export class EdzMessageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private onFetch(): void {
    this.httpSubscription = this.http.get(this.endpoints.edzMessage + '&per_page=3')
